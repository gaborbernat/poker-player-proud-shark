...
public class StartingHandHandler {
	...
	private static Map<String, Integer> mapping = getMapping();
	...
	private final static Map<String, Integer> getMapping() {
		if (mapping == null) {
			mapping = new HashMap<>();
			Properties props = new Properties();
			try {
				props.load(StartingHandHandler.class.getResourceAsStream(PROPERTY_FILE));
