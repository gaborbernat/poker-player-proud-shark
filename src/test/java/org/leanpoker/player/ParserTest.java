...
public class ParserTest {
	...
	public void parseJson() {
		request = new JsonParser().parse(jsonString);
	}

	@Test
	public void testGetOurHand() throws Exception {
		List<Parser.Card> cards = Parser.getHand(request, "Bob");
		assertEquals(cards.get(0).number, 6);
		assertEquals(cards.get(0).suit, Parser.Suit.hearts);
		assertEquals(cards.get(1).number, 13);
		assertEquals(cards.get(1).suit, Parser.Suit.spades);
